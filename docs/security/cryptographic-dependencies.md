...
| Dependency | Resolved version | Enabled features | Registry checksum | Source-scan status | SDK responsibility |
| --- | --- | --- | --- | --- | --- |
| `gmcrypto-core` | `1.11.0` | `default`, `sm4-aead`, `x509` | `4e81a6030cdbef95407ef7924aa2b60469d1263e094b667295cd3d787c2c3095` | reviewed: no unsafe source | Adds SM4-GCM and SM4-CCM sealing and opening for the AEAD envelope mode |
